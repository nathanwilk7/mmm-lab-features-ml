...
plot(train.input$distance_to_grain_boundary, train.dadN)
plot(train.input$unit_vector_to_grain_boundary_x, train.dadN)
plot(train.input$unit_vector_to_grain_boundary_y, train.dadN)
plot(train.input$unit_vector_to_grain_boundary_z, train.dadN)
plot(train.input$phi1, train.dadN)
plot(train.input$Phi, train.dadN)
plot(train.input$phi2, train.dadN)
plot(train.input$misorientation, train.dadN)
plot(train.input$scaled_angle, train.dadN)

lm.fit = lm(train.dadN~., data=train.input)
summary(lm.fit)

train.predictions = predict(lm.fit, train.input)
train.error = sum((train.predictions - train.dadN)^2) / length(train.predictions)

test.predictions = predict(lm.fit, test.input)
test.error = sum((test.predictions - test.dadN)^2) / length(test.predictions)

mean.error = sum((mean(test.dadN) - test.dadN)^2) / length(test.dadN)
